...
public class SmsDemo {
    ...
    static final String accessKeyId = "LTAIo40rA4LV3IfM";
    static final String accessKeySecret = "pMoAZdfxSnuaMNHe14UER2WwzZ9xpv";
    ...
    public SendSmsResponse sendSms(String phone, String code) throws ClientException {
        ...
        //必填:短信签名-可在短信控制台中找到
        request.setSignName("共享篮球");
        //必填:短信模板-可在短信控制台中找到
        request.setTemplateCode("SMS_127157998");
    ...
    public String send(String phone, String code) throws ClientException, InterruptedException {
...
//        Thread.sleep(3000L);
    ...
    public Map<String, String> sendVerificationCode(String smsMod) throws IOException {
        ...
        String code = getSix();
        try {
            String result = send(smsMod, code);
