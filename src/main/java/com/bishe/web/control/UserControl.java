...
import com.bishe.service.sms.SmsDemo;
import com.bishe.utils.data.BasketballData;
import com.bishe.utils.data.ManagementData;
...
public class UserControl {
    ...
    Map<String, Object> sendSMSCode(HttpServletRequest req, HttpSession session) {
        ...
        try {
            ...
            if (regsterPhone != null) {
                ...
                result = smsDemo.sendVerificationCode(regsterPhone);
                ...
                //发送手机号码
                result = smsDemo.sendVerificationCode(phone);
    ...
    Map<String, Object> updatePasswordVerification(HttpServletRequest req, HttpSession session) {
        ...
        try {
            ...
            Map<String, String> resutl = smsDemo.sendVerificationCode(phone);
...
//            String isbad = req.getParameter("isbad");
            ...
            if (remaining >= 0) {
                ...
                if (BasketballData.bottomPerssure>perssure || perssure>BasketballData.topPerssure ){
                    ...
                    basketball.setIsBad(1);
                    basketball.setCabinet(1);
                    String result =  smsDemo.send(ManagementData.MANAGE_PHONE,basketball.getBasketballID()+"号篮球已经损坏，请及时处理");
